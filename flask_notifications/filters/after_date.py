...
class AfterDate(EventFilter):
    """Filter that checks the event date is after a given date."""

    def __init__(self, datetime):
        """Check certain event has been emitted before a date.
